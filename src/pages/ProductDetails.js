import { Route, useParams, useRouteMatch, Link, Switch, useHistory } from "react-router-dom"
...
export default function ProductDetails() {
  ...
  return (
    <div className="content">
      ...
      <p>Klikni <Link to={`/products/${id}/offers`}>ovde</Link> da vidis ponudu.</p>
      <hr />
      <Switch>
        <Route path={`/products/${id}/offers`}>
          <Offers />
        </Route>
      </Switch>
    </div>
